...
//                     <span class="fw-bold fs-5 text-white skeleton skeleton-text"></span>
//                 </div>
//                 <div class="col-6 col-md-3 col-sm-6 text-center mt-3 border-end border-dark">
//                     <p class="skeleton skeleton-text">Ochtend</p>
//                     <div class="skeleton skeleton-img"></div>
//                     <p class="skeleton skeleton-text"></p>
//                 </div>
//                 <div class="col-6 col-md-3 col-sm-6 text-center mt-3 bh-col-bdr border-end border-dark">
//                     <p class="skeleton skeleton-text">Middag</p>
//                     <div class="skeleton skeleton-img"></div>
//                     <p class="skeleton skeleton-text"></p>
//                 </div>
//                 <div class="col-6 col-md-3 col-sm-6 text-center mt-3 border-end border-dark">
//                     <p class="skeleton skeleton-text">Avond</p>
//                     <div class="skeleton skeleton-img"></div>
//                     <p class="skeleton skeleton-text"></p>
//                 </div>
//                 <div class="col-6 col-md-3 col-sm-6 text-center mt-3">
//                     <p class="skeleton skeleton-text">S nachts</p>
//                     <div class="skeleton skeleton-img"></div>
//                     <p class="skeleton skeleton-text"></p>
//                 </div>
//             </div>
...
//       // Display skeletons immediately
//     forecastContainer.html(createSkeletonHTML());
...
jQuery(document).ready(function($) {
    ...
    if (typeof wfp_vars !== 'undefined') {
       ...
       console.log("Constructed API URL:", apiUrl);
        console.log("Hardcoded AJAX URL:", ajaxUrl);

        // Load the images-code.json file
        $.getJSON(imagesUrl, function(imageCodes) {
            console.log('Loaded image codes:', imageCodes);
